...
pub fn le_f64(i: &[u8]) -> (&[u8], f64) {
    (&i[8..], f64::from_le_bytes((&i[..8]).try_into().unwrap()))
}

pub fn le_f32(i: &[u8]) -> (&[u8], f32) {
    (&i[4..], f32::from_le_bytes((&i[..4]).try_into().unwrap()))
}

#[deprecated]
pub fn le_u8(i: &[u8]) -> (&[u8], u8) {
    (&i[1..], i[0])
}
